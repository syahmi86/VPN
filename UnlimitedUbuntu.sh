...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/syahmi86/VPN/master/conf/squid.conf" 
...
echo "-Squid Proxy"
echo "-Vnstat"
echo "AUTOSCRIPTS NIE AKU CURI KIELLEZ PUNYA WKAKAKA"
echo "Sila login ke pritunl untuk proceed step seterusnya"
echo " "
echo "Disediakan Oleh Syahmi"
